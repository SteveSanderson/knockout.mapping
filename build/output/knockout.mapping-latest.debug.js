...
(function() {
    ...
    function mapJsObjectGraph(rootObject, options, visitedObjects, isArrayMember, parentName) {
		...
		if (mappedRootObject === rootObject)
			mappedRootObject = options.mapOutput(outputProperties, isArrayMember);
            ...
            switch (getType(propertyValue)) {
                ...
                case "undefined":
                    ...
                    outputProperty = (previouslyMappedValue !== undefined)
                        ...
                        : mapJsObjectGraph(propertyValue, options, visitedObjects, rootObjectIsArray, indexer);
                    break;
            }
